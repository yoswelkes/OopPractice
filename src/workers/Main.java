...
public class Main {
    public static void main(String[] args) {
        ...
        Person person2 = new WorkerMan("Prince", 30, 8);
        Person person3 = new Woman("Mudidi", 28);
        Person person4 = new WorkerWoman("Hana", 32, 6);
        Person person5 = new Man("Guled", 22);
        Person person6 = new WorkerMan("Wafi", 35, 12);
        Person person7 = new WorkerWoman("Edna", 31, 5);
